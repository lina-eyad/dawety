...
export function HeroSection() {
  return (
    <section id="home" className="relative overflow-hidden bg-background">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col items-center gap-12 px-6 py-14 lg:flex-row lg:justify-between">
        {/* Copy — right side in RTL */}
        <div className="flex w-full max-w-xl flex-col items-center gap-4 text-center lg:w-[50%] lg:items-start lg:text-start">
          ...
          <div className="mt-2 flex flex-wrap items-center justify-center gap-3 lg:justify-start">
            <Button size="lg" className="rounded-[8px] shadow-brand">
              ابدأ التصميم
            </Button>
            <Button size="lg" variant="secondary" className="rounded-[8px]">
              استعرض القوالب
        ...
        <div className="w-full max-w-lg lg:w-[48%]">
          <Image
