...
export function CreateWizard() {
  ...
  return (
    <div className="flex flex-col items-start gap-8 lg:flex-row-reverse">
                ...
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex items-center gap-2.5 rounded-2xl border border-primary/10 bg-rose/50 px-4 py-3.5 text-sm text-ink-muted">
                    <Lightbulb
                      ...
                      aria-hidden
                    />
                    يمكنك تعديل هذه البيانات في أي وقت، وتبقى محفوظة حتى عند
                    تغيير القالب.
                  </div>
                ...
                <div className="flex flex-col gap-7">
                  ...
                  <div className="flex items-center gap-2.5 rounded-2xl border border-primary/10 bg-rose/50 px-4 py-3.5 text-sm text-ink-muted">
                    <Sparkles
                      ...
                      aria-hidden
                    />
                    كل تغيير في الألوان أو الخط أو الخلفية ينعكس فوراً على
                    معاينة دعوتك.
                  </div>
