...
export function FaqSection() {
  return (
    <section id="faq" className="mx-auto w-full max-w-[1000px] px-6 py-20">
      <SectionHeading
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2">
        {FAQS.map((faq) => (
          <details
            key={faq.q}
            className="rounded-2xl border border-warm-border bg-card p-5 shadow-soft open:[&_svg]:rotate-45"
          >
      ...
      {/* Contact card */}
      <div className="mt-8 flex flex-col items-center justify-between gap-4 rounded-3xl border border-warm-border bg-rose/40 px-8 py-6 text-center sm:flex-row sm:text-start">
        <div>
